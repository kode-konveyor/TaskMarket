...
public class UserTestData {
  ...
  public final static Long ID = 1209L;
  public final static String LOGIN = "gituser";

  public final static Long ID_BAD = 1210L;
  public static final String LOGIN_BAD = "baduser";

  public final static Long ID_REGISTERED = 1211L;
  public static final String LOGIN_REGISTERED = "registered";
