...
public class TechnicalTestData {
  ...
  public static final String TASKS_EQUAL_MESSAGE =
      "Too low 'up for grab' tasks for project : kode-konveyor/TaskMarket . Currently 'up for grab' tasks count : 2 , the minimum count of 'up for grab' tasks required : 2";
